  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-16">
      ...
      <div className="mt-16 bg-gray-900 text-white rounded-2xl p-8 text-center">
        <p className="font-bold text-lg mb-2">ぷらっとハウス西新宿</p>
        <p className="text-gray-400 text-sm mb-6">西新宿５丁目駅 徒歩10分・初台駅 徒歩10分・一棟貸し切り（戸建）・最大4名</p>
        <a
          href="https://beds24.com/booking.php?propid=257190&referer=BookingLink"
